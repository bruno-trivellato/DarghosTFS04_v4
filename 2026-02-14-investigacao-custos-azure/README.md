...
- Data: 14/02/2026
- Todos os recursos Darghos no Azure foram deletados (containers, registry, storage accounts)
- Economia: ~$290/mes (~$3.480/ano)
- Nenhum dado foi perdido (banco estava vazio)
- Para rodar novamente: `docker compose up` local
