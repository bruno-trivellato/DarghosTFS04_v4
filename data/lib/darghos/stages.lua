...
stages = {
	...
	[STAGES_EXP_NOVIUM] = {
		{start_level = 1, end_level = 59, multipler = 3}
	    ,{start_level = 60, end_level = 119, multipler = 2}
	    ,{start_level = 120, end_level = 219, multipler = 1.5}
      ,{start_level = 220, multipler = 1.0}
	},

	[STAGES_EXP_NOVIUM_PROTECTED] = {
		{start_level = 1, end_level = 59, multipler = 3}
    	,{start_level = 60, multipler = 1.5}
	},
