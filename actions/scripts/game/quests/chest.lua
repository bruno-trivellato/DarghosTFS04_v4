...
local quests =
	{
		...
		[uid.ARENA_GREENHORN_ORCISH_MAL] = {
			storageId = sid.ARENA_GREENHORN_REWARD,
			rewardId = 7392,
			count = 1
		},
		[uid.ARENA_GREENHORN_HEADSCHOPPER] = {
			storageId = sid.ARENA_GREENHORN_REWARD,
			rewardId = 7380,
			count = 1
		},
		[uid.ARENA_GREENHORN_BLACKSTEEL] = {
			storageId = sid.ARENA_GREENHORN_REWARD,
			rewardId = 7406,
			count = 1
		},
				
		[uid.ARENA_SCRAPPER_CRANIAL_BASHER] = {
			storageId = sid.ARENA_SCRAPPER_REWARD,
			rewardId = 7415,
			count = 1
		},
		[uid.ARENA_SCRAPPER_HEROIC_AXE] = {
			storageId = sid.ARENA_SCRAPPER_REWARD,
			rewardId = 7389,
			count = 1
		},
		[uid.ARENA_SCRAPPER_MYSTIC_BLADE] = {
			storageId = sid.ARENA_SCRAPPER_REWARD,
			rewardId = 7384,
			count = 1
		},
				
		[uid.ARENA_WARLORD_BLESSED_SCEPTRE] = {
			storageId = sid.ARENA_WARLORD_REWARD,
			rewardId = 7429,
			count = 1
		},
		[uid.ARENA_WARLORD_ROYAL_AXE] = {
			storageId = sid.ARENA_WARLORD_REWARD,
			rewardId = 7434,
			count = 1
		},
		[uid.ARENA_WARLORD_JUSTICE_SEEKER] = {
			storageId = sid.ARENA_WARLORD_REWARD,
			rewardId = 7390,
			count = 1
		},
		...
		[uid.HELMET_OF_THE_DEEP_QUEST] = {
			storageId = sid.HELMET_OF_THE_DEEP_REWARD,
			rewardId = 12541,
			count = 1
		},		
...
function useQuestChest(cid, quest, questActionId)
	...
	if queststatus == -1 then
		...
		elseif(quest.rewardContainer ~= nil) then
			...
			for key, value in pairs(containerItems) do
				...
				doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "You have found a " .. getItemNameById(value.itemid) .. ".")
			end
		end
