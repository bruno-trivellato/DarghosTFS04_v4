...
ACLOCAL = ${SHELL} /mnt/hgfs/ultrax/source/missing --run aclocal-1.11
AMTAR = ${SHELL} /mnt/hgfs/ultrax/source/missing --run tar
AUTOCONF = ${SHELL} /mnt/hgfs/ultrax/source/missing --run autoconf
AUTOHEADER = ${SHELL} /mnt/hgfs/ultrax/source/missing --run autoheader
AUTOMAKE = ${SHELL} /mnt/hgfs/ultrax/source/missing --run automake-1.11
AWK = mawk
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
LUA_LIBS = -llua5.1  
MAKEINFO = ${SHELL} /mnt/hgfs/ultrax/source/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MYSQL_FLAGS = -D__USE_MYSQL__
MYSQL_LIBS = -lmysqlclient
OBJEXT = o
OPTIONAL_FLAGS = -D__WAR_SYSTEM__ -D__NO_CRYPTOPP__ -D__TFS_NEWEST_REVS_FIXIES__  -D__DARGHOS_CUSTOM__ -D__DARGHOS_SPOOF__ -D__DARGHOS_EMERGENCY_DDOS__ -D__ENABLE_SERVER_DIAGNOSTIC__
...
XML_LIBS = -lxml2
abs_builddir = /mnt/hgfs/ultrax/source
abs_srcdir = /mnt/hgfs/ultrax/source
abs_top_builddir = /mnt/hgfs/ultrax/source
abs_top_srcdir = /mnt/hgfs/ultrax/source
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /mnt/hgfs/ultrax/source/install-sh
